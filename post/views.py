...
class PostLikeApiView(APIView):
    ...
    def post(self, request, pk):
        try:
            ...
            data = {
                "success": True,
                "message": "Like Successfully ochirildi",
            }
            ...
            data = {
                "success": True,
                "message": "Like Successfully qoyildi",
                "data": serializer.data
            }
...
class CommentLikeApiView(APIView):
    ...
    def post(self, request, pk):
        try:
            ...
            data = {
                "success": True,
                "message": "Like successfully o'chirildi"
            }
            return Response(data, status=status.HTTP_204_NO_CONTENT)
            ...
            data = {
                "success": True,
                "message": "Commentga Like qo'yildi",
                "data": serializer.data
            }
            return Response(data, status=status.HTTP_201_CREATED)
    ...
    #         data = {
    #             "success": True,
    #             "message": "Comment Like successfully o'chirildi",
    #             "data": None
    #         }
    #         return Response(data, status=status.HTTP_204_NO_CONTENT)
    #     except Exception as e:
